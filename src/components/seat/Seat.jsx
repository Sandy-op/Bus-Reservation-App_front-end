...
//     return (
//         <div className="sapce-y-5 my-4 h-full">
//             <h2 className="text-xl text-neutral-800 dark:text-neutral-100 font-medium pb-5 ">
//                 Choose a Seat
//             </h2>

//             {/* Seat Layout */}
//             <div className="w-full flex flex-col sm:flex-row items-center space-y-5 sm:space-y-0 sm:space-x-5">
...
//                             <div className="flex-1 sapce-y-4">
